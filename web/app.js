...
// Exposed function for Python to update agent list
eel.expose(update_agent_list);
function update_agent_list(result) {
  if (result && result.ok) {
    agents = result.agents || [];
    renderAgents();
  }
...
// Exposed function for Python to add events
eel.expose(add_observability_event);
function add_observability_event(event) {
